...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2017 at 12:42 AM
...
('CIBC Run For The Cure', '2016-10-02 22:00:00', '2016-10-03 00:00:00', 'On October 2nd at the Canadian Breast Cancer Foundation CIBC Run for the Cure, nearly one hundred thousand people came together in communities across Canada in support of our shared vision of a future');
...
CREATE TABLE `sponsors` (
  `spsname` varchar(50) NOT NULL,
  `spsdesc` varchar(2000) NOT NULL,
  `spacronym` varchar(20) DEFAULT NULL,
...
INSERT INTO `sponsors` (`spsname`, `spsdesc`, `spacronym`, `spphone`, `spemail`, `spfax`) VALUES
('Canadian Imperial Bank of Commerce', 'At CIBC, we are in business to help our clients, employees and shareholders achieve what is important to them. Our ability to create value for all CIBC stakeholders is driven by a business culture based on common values: Trust, Teamwork and Accountability.', 'CIBC', '8663022223', NULL, NULL);
